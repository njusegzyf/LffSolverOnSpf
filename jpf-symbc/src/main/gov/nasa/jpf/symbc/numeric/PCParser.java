...
/**
 * @author JPF, Zhang Yifan
 * @version 0.1 Fix code for handling non linear constraints, since LFF solver can also handle them as well as coral.
 */
public class PCParser {
  ...
  static Object getExpression(IntegerExpression eRef) {
    ...
    if (eRef instanceof BinaryLinearIntegerExpression) {
      ...
      if (PCParser.canDpHandleNonLinearIntegerConstraint()) {
      ...
      } else { throw new RuntimeException("## Error: Binary Non Linear Expression " + eRef); }
    }
    switch (opRef) {
    case PLUS:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.plus(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).value); } else {
    ...
    case MINUS:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.minus(getExpression(e_leftRef), ((IntegerConstant) e_rightRef).value); } else {
    ...
    case MUL:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.mult(((IntegerConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
        if (PCParser.canDpHandleNonLinearIntegerConstraint()) {
    ...
    case DIV:
      ...
      { return pb.div(((IntegerConstant) e_leftRef).value, getExpression(e_rightRef)); } else if (e_rightRef instanceof IntegerConstant) {
    ...
    case AND:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.and(((IntegerConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
    ...
    case OR:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.or(((IntegerConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
    ...
    case XOR:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.xor(((IntegerConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
    ...
    case SHIFTR:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.shiftR(((IntegerConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
    ...
    case SHIFTUR:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.shiftUR(((IntegerConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
    ...
    case SHIFTL:
      ...
      } else if (e_rightRef instanceof IntegerConstant) { return pb.shiftL(((IntegerConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
  ...
  static Object getExpression(RealExpression eRef) {
    ...
    if (eRef instanceof BinaryRealExpression) {
      ...
      case PLUS:
        ...
        } else if (e_rightRef instanceof RealConstant) { return pb.plus(getExpression(e_leftRef), ((RealConstant) e_rightRef).value); } else {
          return pb.plus(getExpression(e_leftRef), getExpression(e_rightRef));
        }
      case MINUS:
        if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant) {
        ...
        } else if (e_rightRef instanceof RealConstant) { return pb.minus(getExpression(e_leftRef), ((RealConstant) e_rightRef).value); } else {
          return pb.minus(getExpression(e_leftRef), getExpression(e_rightRef));
        }
      case MUL:
        if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant) {
        ...
        } else if (e_rightRef instanceof RealConstant) { return pb.mult(((RealConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
          return pb.mult(getExpression(e_leftRef), getExpression(e_rightRef));
        }
      case DIV:
        if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant) {
        ...
        } else if (e_rightRef instanceof RealConstant) { return pb.div(getExpression(e_leftRef), ((RealConstant) e_rightRef).value); } else {
          return pb.div(getExpression(e_leftRef), getExpression(e_rightRef));
        }
      case AND:
        if (e_leftRef instanceof RealConstant && e_rightRef instanceof RealConstant) {
        ...
        } else if (e_rightRef instanceof RealConstant) { return pb.and(((RealConstant) e_rightRef).value, getExpression(e_leftRef)); } else {
          return pb.and(getExpression(e_leftRef), getExpression(e_rightRef));
        }
    ...
    if (eRef instanceof MathRealExpression) {
      ...
      case POW:
        ...
        } else if (e_arg1Ref instanceof RealConstant) { return pb.power(((RealConstant) e_arg1Ref).value, getExpression(e_arg2Ref)); } else {
      ...
      case ATAN2:
        ...
        } else if (e_arg1Ref instanceof RealConstant) { return pb.atan2(((RealConstant) e_arg1Ref).value, getExpression(e_arg2Ref)); } else {
  ...
  static public boolean createDPMixedConstraint(MixedConstraint cRef) { // TODO
    ...
    if (c_leftRef instanceof SymbolicReal && c_rightRef instanceof SymbolicInteger) {
      ...
      if (c_rightRef instanceof IntegerConstant) { pb.post(pb.eq(((IntegerConstant) c_rightRef).value, tmpi)); } else {
      ...
      if (c_leftRef instanceof RealConstant) { pb.post(pb.eq(tmpr, ((RealConstant) c_leftRef).value)); } else {
  ...
  static public boolean createDPRealConstraint(RealConstraint cRef) {
    ...
    case EQ:
      if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
        if (!(((RealConstant) c_leftRef).value == ((RealConstant) c_rightRef).value)) { return false; } else { return true; }
      ...
      } else { pb.post(pb.eq(getExpression(c_leftRef), getExpression(c_rightRef))); }
      break;
    case NE:
      if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
        if (!(((RealConstant) c_leftRef).value != ((RealConstant) c_rightRef).value)) { return false; } else { return true; }
      ...
      } else { pb.post(pb.neq(getExpression(c_leftRef), getExpression(c_rightRef))); }
      break;
    case LT:
      if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
        if (!(((RealConstant) c_leftRef).value < ((RealConstant) c_rightRef).value)) { return false; } else { return true; }
      ...
      } else { pb.post(pb.lt(getExpression(c_leftRef), getExpression(c_rightRef))); }
      break;
    case GE:
      if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
        if (!(((RealConstant) c_leftRef).value >= ((RealConstant) c_rightRef).value)) { return false; } else { return true; }
      ...
      } else { pb.post(pb.geq(getExpression(c_leftRef), getExpression(c_rightRef))); }
      break;
    case LE:
      if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
        if (!(((RealConstant) c_leftRef).value <= ((RealConstant) c_rightRef).value)) { return false; } else { return true; }
      ...
      } else { pb.post(pb.leq(getExpression(c_leftRef), getExpression(c_rightRef))); }
      break;
    case GT:
      if (c_leftRef instanceof RealConstant && c_rightRef instanceof RealConstant) {
        if (!(((RealConstant) c_leftRef).value > ((RealConstant) c_rightRef).value)) { return false; } else { return true; }
      ...
      } else { pb.post(pb.gt(getExpression(c_leftRef), getExpression(c_rightRef))); }
      break;
    }
    return true;
  }
  ...
  static public boolean createDPLinearIntegerConstraint(LinearIntegerConstraint cRef) {
    ...
    case EQ:
      if (c_leftRef instanceof IntegerConstant && c_rightRef instanceof IntegerConstant) {
        if (!(((IntegerConstant) c_leftRef).value == ((IntegerConstant) c_rightRef).value)) { return false; } else { return true; }
      } else if (c_leftRef instanceof IntegerConstant) {
  ...
  public static ProblemGeneral parse(PathCondition pc, ProblemGeneral pbtosolve) {
    ...
    while (cRef != null) {
      ...
      if (cRef instanceof RealConstraint) {
        ...
        // @since 0.1
        // modified as LFF solver can also handle non linear integer constraint
