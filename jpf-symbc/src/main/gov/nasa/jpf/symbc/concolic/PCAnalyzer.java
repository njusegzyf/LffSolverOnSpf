...
public final class PCAnalyzer {
  ...
  public boolean mixedIsSatisfiable(PathCondition working_pc, SymbolicConstraintsGeneral solver) {
    ...
    if (SymbolicInstructionFactory.debugMode) {
      if (result) { System.out.println("combined PC satisfiable"); } else { System.out.println("combined PC not satisfiable"); }
    }
  ...
  public boolean isSatisfiable(PathCondition pc, SymbolicConstraintsGeneral solver) {
    ...
    if (!SymbolicInstructionFactory.heuristicPartitionMode) {
      ...
      if (SymbolicInstructionFactory.debugMode) { System.out.println("--------start Partition Heuristic------------" + tries); }
  ...
  public void splitPathCondition(PathCondition pc) {
    ...
    while (cRef != null) {
      if (cRef instanceof RealConstraint) {
        ...
        { concolicPC.prependUnlessRepeated(new RealConstraint((RealConstraint) cRef)); } else {
  ...
  boolean isComplex(RealExpression eRef) {
    if (eRef instanceof SymbolicReal || eRef instanceof RealConstant) { return false; }

    if (eRef instanceof MathRealExpression || eRef instanceof FunctionExpression) { return true; }
